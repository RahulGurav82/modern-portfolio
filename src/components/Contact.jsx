            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({href, icon}, key) => (
                        ...
                        target='_blank'
                        href={href}
                        className='w-12 h-12 grid place-content-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] 
            ...
            >
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete='email'
                        required
                        placeholder='guravrahul988@gmail.com'
                        className='text-field'
                        />
                    </div>
                </div>
